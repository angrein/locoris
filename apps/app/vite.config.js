...
function resolveManualChunk(id) {
    ...
    const hasPackage = (packageName) => normalizedId.includes(`/node_modules/${packageName}/`);
    if (!normalizedId.includes("/node_modules/")) {
        return undefined;
    }
    if (hasPackage("@blocknote/core") ||
        hasPackage("@blocknote/mantine") ||
        hasPackage("@blocknote/react")) {
        return "vendor-blocknote";
    }
    if (hasPackage("@tiptap/core") ||
